...
use super::{ResourcePattern, Effect};
...
impl From<AclOperation> for Permission {
    fn from(operation: AclOperation) -> Self {
        match operation {
            AclOperation::Read | AclOperation::List | AclOperation::Connect | AclOperation::Describe => Permission::Read,
            AclOperation::Write => Permission::Write,
            AclOperation::Admin | AclOperation::Cluster | AclOperation::All | AclOperation::Delete | AclOperation::Alter | AclOperation::Create => Permission::Admin,
        }
    }
}
...
mod tests {
    use super::*;
    use crate::security::acl::{ResourceType, Effect};
