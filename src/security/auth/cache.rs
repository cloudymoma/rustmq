...
impl L2AclCache {
    ...
    pub fn new(shard_count: usize, metrics: Arc<SecurityMetrics>) -> Result<Self> {
        ...
        let shards: Vec<DashMap<AclKey, AclCacheEntry>> =
            (0..shard_count).map(|_| DashMap::new()).collect();
...
impl L3NegativeCache {
    ...
    pub fn new(max_items: usize, false_positive_rate: f64, metrics: Arc<SecurityMetrics>) -> Self {
...
impl AclCache {
    ...
    pub async fn get(&self, l1_cache: &L1AclCache, key: &AclKey) -> Option<bool> {
        // L1 check first
    ...
    pub async fn put(&self, l1_cache: &L1AclCache, key: AclKey, allowed: bool) {
        // Update L1
