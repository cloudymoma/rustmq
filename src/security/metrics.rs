...
impl SecurityMetrics {
    ...
    pub fn record_authentication_success(&self, latency: Duration) {
        ...
        self.auth_latency_sum_nanos.fetch_add(latency.as_nanos() as u64, Ordering::Relaxed);
    ...
    pub fn record_certificate_parse_latency(&self, latency: Duration) {
        self.cert_parse_latency_sum_nanos.fetch_add(latency.as_nanos() as u64, Ordering::Relaxed);
    }
    ...
    pub fn record_authorization_latency(&self, latency: Duration) {
        self.authz_latency_sum_nanos.fetch_add(latency.as_nanos() as u64, Ordering::Relaxed);
    ...
    pub fn record_cache_cleanup(&self, cleaned_count: usize) {
        self.l2_cache_cleanups.fetch_add(cleaned_count as u64, Ordering::Relaxed);
    }
    ...
    pub fn record_batch_fetch(&self, batch_size: usize) {
        ...
        self.batch_fetch_size_sum.fetch_add(batch_size as u64, Ordering::Relaxed);
    }
    
    pub fn record_batch_fetch_latency(&self, latency: Duration) {
        self.batch_fetch_latency_sum_nanos.fetch_add(latency.as_nanos() as u64, Ordering::Relaxed);
    }
    ...
    pub fn record_mtls_handshake_success(&self, latency: Duration) {
        ...
        self.mtls_handshake_latency_sum_nanos.fetch_add(latency.as_nanos() as u64, Ordering::Relaxed);
    }
    ...
    pub fn record_connection_established(&self) {
        self.active_authenticated_connections.fetch_add(1, Ordering::Relaxed);
        self.connection_churn_count.fetch_add(1, Ordering::Relaxed);
    }
    
    pub fn record_connection_closed(&self) {
        self.active_authenticated_connections.fetch_sub(1, Ordering::Relaxed);
        self.connection_churn_count.fetch_add(1, Ordering::Relaxed);
    }
    ...
    pub fn average_mtls_handshake_latency_nanos(&self) -> f64 {
        let sum = self.mtls_handshake_latency_sum_nanos.load(Ordering::Relaxed);
    ...
    pub fn active_connections(&self) -> u64 {
        self.active_authenticated_connections.load(Ordering::Relaxed)
    }
    ...
    pub fn snapshot(&self) -> SecurityMetricsSnapshot {
        SecurityMetricsSnapshot {
            ...
            // Connections
            active_connections: self.active_authenticated_connections.load(Ordering::Relaxed),
...
impl SecurityMetricsSnapshot {
    ...
    pub fn has_acceptable_security_posture(&self) -> bool {
        let total_operations = self.auth_success_count + self.auth_failure_count + 
                               self.authz_success_count + self.authz_failure_count;
...
mod tests {
    ...
    fn test_metrics_snapshot() {
        ...
        assert!(snapshot.has_healthy_cache_performance(), 
                "L1 hit rate: {}, L2 hit rate: {}", 
                snapshot.l1_cache_hit_rate, snapshot.l2_cache_hit_rate);
