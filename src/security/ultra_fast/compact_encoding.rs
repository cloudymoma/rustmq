...
impl BatchPermissionEncoder {
    ...
    pub fn check_permissions_scalar(permission_masks: &[u32], required_masks: &[u32]) -> Vec<bool> {
        permission_masks
            .iter()
...
mod tests {
    ...
    fn test_scalar_permission_checking() {
        ...
        let results =
            BatchPermissionEncoder::check_permissions_scalar(&permission_masks, &required_masks);
