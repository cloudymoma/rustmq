...
impl BranchlessRecordBatchParser {
    ...
    pub fn parse_record_headers_batch(
        ...
        self.stats.average_parse_time_ns = (self.stats.average_parse_time_ns + parse_time) / 2;
...
mod tests {
    ...
    fn test_branchless_validation() {
        ...
        assert_eq!(
            BranchlessRecordBatchParser::validate_record_size_branchless(100),
            1
        );
        assert_eq!(
            BranchlessRecordBatchParser::validate_record_size_branchless(4),
            0
        ); // Too small
        assert_eq!(
            BranchlessRecordBatchParser::validate_record_size_branchless(100 * 1024 * 1024),
            0
        ); // Too large
    ...
    fn test_checksum_validation() {
        ...
        // Valid checksum
        assert!(BranchlessValidation::validate_checksum_branchless(
            data, checksum
        ));
