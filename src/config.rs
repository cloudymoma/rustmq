...
mod tests {
    ...
    fn test_toml_serialization_deserialization() {
        ...
        assert_eq!(
            config.per_ip.max_tracked_ips,
            deserialized.per_ip.max_tracked_ips
        );
        assert_eq!(
            config.endpoints.health.requests_per_second,
            deserialized.endpoints.health.requests_per_second
        );
    }
