...
mod tests {
    ...
    use super::api_client::{ApiResponse, GenerateCaRequest, IssueCertificateRequest, RevokeCertificateRequest};
    ...
    fn test_issue_certificate_request() {
        let request = IssueCertificateRequest {
            ...
            key_usage: Some(vec!["digital_signature".to_string(), "key_encipherment".to_string()]),
    ...
    fn test_certificate_validation_request() {
        let request = CertificateValidationRequest {
            ...
            chain_pem: Some(vec!["-----BEGIN CERTIFICATE-----\nMIIC...\n-----END CERTIFICATE-----".to_string()]),
    ...
    fn test_csv_escape_value() {
        ...
        assert_eq!(csv_escape_value(&quote_value), "\"value\"\"with\"\"quotes\"");
        
        let newline_value = json!("value\nwith\nnewlines");
        assert_eq!(csv_escape_value(&newline_value), "\"value\nwith\nnewlines\"");
